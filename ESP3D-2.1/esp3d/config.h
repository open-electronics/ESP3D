...
// Sonoff features
#define SONOFF_FEATURE



//which serial ESP use to communicate to printer (ESP32 has 3 serials available) N.B. Uncomment one only
//#define USE_SERIAL_0
#define USE_SERIAL_1
//#define USE_SERIAL_2
...
#define EP_DHT_INTERVAL              163 //4  bytes = int
#define ESP_NOTIFICATION_TYPE        167 //1 byte = flag
#define ESP_AUTO_NOTIFICATION        168 //1  bytes = flag
#define EP_FREE_BYTE1                169 //1  bytes = flag
#define EP_FREE_INT3                 170 //4  bytes = int
#define EP_ADMIN_PWD                 174 //21  bytes 20+1 = string  ; warning does not support multibyte char like chinese
#define EP_USER_PWD                  195 //21  bytes 20+1 = string  ; warning does not support multibyte char like chinese
#define EP_AP_SSID                   216 //33 bytes 32+1 = string  ; warning does not support multibyte char like chinese
#define EP_AP_PASSWORD               249 //65 bytes 64 +1 = string ;warning does not support multibyte char like chinese
#define EP_AP_IP_VALUE               314 //4  bytes xxx.xxx.xxx.xxx
#define EP_AP_MASK_VALUE             318 //4  bytes xxx.xxx.xxx.xxx
#define EP_AP_GATEWAY_VALUE          322 //4  bytes xxx.xxx.xxx.xxx
#define EP_AP_IP_MODE                326 //1 byte = flag
#define EP_AP_PHY_MODE               327 //1 byte = flag
#define EP_SD_SPEED_DIV              328 //1 byte = flag
#define ESP_NOTIFICATION_TOKEN1      329 //64 bytes 63+1 = string  ; warning does not support multibyte char like chinese
#define ESP_NOTIFICATION_TOKEN2      393 //64 bytes 63+1 = string  ; warning does not support multibyte char like chinese
#define EP_DHT_TYPE                  457 //1  bytes = flag
#define EP_TARGET_FW                 458 //1  bytes = flag
#define EP_TIMEZONE                  459 //1  bytes = flag
#define EP_TIME_ISDST                460 //1  bytes = flag
#define EP_TIME_SERVER1              461 //128 bytes 127+1 = string  ; warning does not support multibyte char like chinese  
#define EP_TIME_SERVER2              589 //128 bytes 127+1 = string  ; warning does not support multibyte char like chinese
#define EP_TIME_SERVER3              717 //128 bytes 127+1 = string  ; warning does not support multibyte char like chinese
#define EP_IS_DIRECT_SD              845 //1  bytes = flag
#define EP_PRIMARY_SD                846 //1  bytes = flag
#define EP_SECONDARY_SD              847 //1  bytes = flag
#define EP_DIRECT_SD_CHECK           848 //1  bytes = flag
#define EP_SD_CHECK_UPDATE_AT_BOOT   849 //1  bytes = flag
#define ESP_NOTIFICATION_SETTINGS    850 //128 bytes 127+1 = string  ; warning does not support multibyte char like chinese
#define EP_EEPROM_VERSION            978 // 6 bytes = ESP3D<V on one byte>
#define ESP_SONOFF_TYPE              984 //1 byte = flag
#define ESP_SONOFF_IP1               985 //4 bytes xxx.xxx.xxx.xxx
#define ESP_SONOFF_IP2               989 //4 bytes xxx.xxx.xxx.xxx


#define LAST_EEPROM_ADDRESS 993
...
#define DEFAULT_SONOFF_TYPE   1
#define ESP_SONOFF_LEGACY     1
#define ESP_SONOFF_TASMOTA    2
...
const uint16_t Setting[][2] = {
	...
	{ESP_SONOFF_IP1, LEVEL_ADMIN},//40
	{ESP_SONOFF_IP2, LEVEL_ADMIN}//41
