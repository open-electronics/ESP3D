    ...
    case 400: {
      ...
      if (!CONFIG::read_byte (ESP_SONOFF_TYPE, &bbuf ) ) {
          ...
          ESPCOM::print ( (const char *) CONFIG::intTostr (bbuf), output, espresponse);
			...
			ESPCOM::print (F("\",\"H\":\"SonoffType\",\"O\":[{\"None\":\"0\"},{\"SonOff DIY\":\""), output, espresponse);      
      ...
      ESPCOM::print ( (const char *) CONFIG::intTostr (ESP_SONOFF_TASMOTA), output, espresponse);  
            ...
            ESPCOM::print (F ("\",\"H\":\"Controllo Luce\"}"), output, espresponse);
            ESPCOM::println (F (","), output, espresponse);
            ...
            ESPCOM::print (F ("\",\"H\":\"Controllo Power\"}"), output, espresponse);
