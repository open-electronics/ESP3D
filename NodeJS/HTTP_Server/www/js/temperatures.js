...
function init_temperature_panel() {
  ...
  smoothieextuder.streamTo(
    getById("extruderTempgraph"),
    3000 /*delay*/
  );
  smoothiebed.streamTo(getById("bedTempgraph"), 3000 /*delay*/);
}
...
function start_graph_output() {
  getById("temperatures_output").style.display = "block";
...
function on_autocheck_temperature(use_value) {
  if (typeof use_value !== "undefined")
    getById("autocheck_temperature").checked = use_value;
  if (getById("autocheck_temperature").checked) {
    var interval = parseInt(
      getById("tempInterval_check").value
    );
    if (!isNaN(interval) && interval > 0 && interval < 100) {
      ...
      getById("autocheck_temperature").checked = false;
      getById("tempInterval_check").value = 0;
      if (interval_temperature != -1) clearInterval(interval_temperature);
...
function onTempIntervalChange() {
  var interval = parseInt(getById("tempInterval_check").value);
  if (!isNaN(interval) && interval > 0 && interval < 100) {
...
function process_Temperatures(response) {
  ...
  while ((result = regex_temp.exec(response)) !== null) {
    ...
    if (tool == "T" || tool == "T0") {
      ...
      getById("heaterT0DisplayTemp").innerHTML = value;
      //to see if heating or not
      if (Number(value2) > 0)
        getById("heaterT0TargetTemp_anime").style.visibility =
          "visible";
      else
        getById("heaterT0TargetTemp_anime").style.visibility =
          "hidden";
      ...
      getById("heaterRDisplayTemp").innerHTML = value;
      if (Number(value2) > 0)
        getById("heaterRTargetTemp_anime").style.visibility =
          "visible";
      else
        getById("heaterRTargetTemp_anime").style.visibility =
          "hidden";
      ...
      getById("heaterT1DisplayTemp").innerHTML = value;
      if (Number(value2) > 0)
        getById("heaterT1TargetTemp_anime").style.visibility =
          "visible";
      else
        getById("heaterT1TargetTemp_anime").style.visibility =
          "hidden";
      ...
      getById("probeDisplayTemp").innerHTML = value;
      if (Number(value2) > 0)
        getById("probeTargetTemp_anime").style.visibility =
          "visible";
      else
        getById("probeTargetTemp_anime").style.visibility =
          "hidden";
      ...
      getById("bedDisplayTemp").innerHTML = value;
      if (Number(value2) > 0)
        getById("bedTargetTemp_anime").style.visibility =
          "visible";
      else
        getById("bedTargetTemp_anime").style.visibility =
          "hidden";
      ...
      getById("chamberDisplayTemp").innerHTML = value;
      if (Number(value2) > 0)
        getById("chamberTargetTemp_anime").style.visibility =
          "visible";
      else
        getById("chamberTargetTemp_anime").style.visibility =
          "hidden";
...
function temperature_heatOff(target) {
  switch (target) {
    case "T0":
      getById("heaterT0SelectedTemp").value = 0;
      getById("heaterT0TargetTemp_anime").style.visibility =
        "hidden";
      getById("heaterRDisplayTemp").value = 0;
      getById("heaterRTargetTemp_anime").style.visibility =
        "hidden";
      break;
    case "T1":
      getById("heaterT1SelectedTemp").value = 0;
      getById("heaterT1TargetTemp_anime").style.visibility =
        "hidden";
      break;
    case "bed":
      getById("bedSelectedTemp").value = 0;
      getById("bedTargetTemp_anime").style.visibility =
        "hidden";
      break;
    case "chamber":
      getById("chamberSelectedTemp").value = 0;
      getById("chamberTargetTemp_anime").style.visibility =
        "hidden";
      break;
  }
  ...
  switch (target) {
    case "T0":
      selectedTemp = parseInt(
        getById("heaterT0SelectedTemp").value
      );
      if (
        selectedTemp < 0 ||
        selectedTemp > 999 ||
    ...
    case "T1":
      selectedTemp = parseInt(
        getById("heaterT1SelectedTemp").value
      );
      if (
        selectedTemp < 0 ||
        selectedTemp > 999 ||
      ...
      break;
    case "bed":
      selectedTemp = parseInt(getById("bedSelectedTemp").value);
      if (
        selectedTemp < 0 ||
        selectedTemp > 999 ||
        isNaN(selectedTemp) ||
    ...
    case "chamber":
      selectedTemp = parseInt(
        getById("chamberSelectedTemp").value
      );
      if (
        selectedTemp < 0 ||
        selectedTemp > 999 ||
